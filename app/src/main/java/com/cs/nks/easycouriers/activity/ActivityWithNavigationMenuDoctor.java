...
public class ActivityWithNavigationMenuDoctor extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myContext = ActivityWithNavigationMenuDoctor.this;
        ...
        if (new ConnectionDetector(ActivityWithNavigationMenuDoctor.this).isConnectingToInternet()) {
...
/***********************************************/
     ...
     /*   } else if (id == R.id.nav_book) {
            ...
            replaceFragmnt(new DoctorProfilefragment());
        }
    ...
    public void replaceFragmnt(Fragment fragment) {
        ...
        fragmentTransaction.commit();
        //
        ActivityWithNavigationMenuDoctor.this.overridePendingTransition(R.anim.left_in, R.anim.left_out);
    ...
    public void manupulateDrawerItems() {
        ...
        String Uid = UTIL.getPref(ActivityWithNavigationMenuDoctor.this, UTIL.Key_UserId);
        if (true) {
            //if (Uid != null && (!Uid.equals(""))) {
            navigationView.inflateMenu(R.menu.menu_drawer_doctor);
...
//            }
            ...
            try {
                PackageManager manager = ActivityWithNavigationMenuDoctor.this.getPackageManager();
                PackageInfo info = manager.getPackageInfo(ActivityWithNavigationMenuDoctor.this.getPackageName(), 0);
    ...
    private void dialog_LOGOUT() {
        ...
        positiveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                alertDialog.dismiss();
                UTIL.clearPref(ActivityWithNavigationMenuDoctor.this);
                Intent abc = new Intent(ActivityWithNavigationMenuDoctor.this, Tab_Login_Register_Activity.class);
                startActivity(abc);
                Toast.makeText(ActivityWithNavigationMenuDoctor.this, "Logout successfully", Toast.LENGTH_SHORT).show();
                finish();
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            drawer.closeDrawer(GravityCompat.START);
             ...
             BranchListfragment myFragment =( BranchListfragment) getSupportFragmentManager().findFragmentByTag("1");
    ...
    private void dialog_Exit() {
        ...
        positiveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                alertDialog.dismiss();
                ActivityWithNavigationMenuDoctor.this.finishAffinity();
    ...
    private class checkVersionUpdate extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            progressDialog = new ProgressDialog(ActivityWithNavigationMenuDoctor.this);
